...
在此基础上，由 Dusty 与 墨鱼小丸子 同学共同优化，构建了一个完整的心理动力学模型，用以模拟“幻想频率”与“情绪稳定性”的动态变化。This project extends a public formula proposed on Zhihu, formalizing it into a computational model of emotional dynamics — exploring how fantasy frequency and self‑control interact over time.
